---
title: "Community Gallery: Browse and Search Shared AI Art"
sidebarTitle: "Community Gallery"
description: "Explore AI-generated artwork from every Akari Art user in a responsive grid. Search by creator name or prompt, and download any image with one click."
---
...
<CardGroup cols={2}>
  <Card title="Desktop hover" icon="desktop" href="/features/community-gallery">
  ...
  <Card title="Mobile tap" icon="mobile" href="/features/community-gallery">
