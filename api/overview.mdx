---
title: "Akari Art REST API Overview — Routes & Auth"
sidebarTitle: "Overview"
description: "A complete reference for all Akari Art API routes, authentication requirements, request/response formats, and error handling conventions used across the platform."
---
