---
title: "Akari Art System Architecture: A Technical Overview"
...
<CardGroup cols={2}>
  <Card title="Frontend — Next.js App Router" icon="browser" href="/architecture/overview">
  ...
  <Card title="API Routes — Next.js Route Handlers" icon="code" href="/api/overview">
  ...
  <Card title="Database Layer — MongoDB + Mongoose" icon="database" href="/architecture/data-models">
  ...
  <Card title="External Services — Cloudflare AI + Cloudinary" icon="cloud" href="/architecture/integrations">
